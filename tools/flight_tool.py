...
def search_flights(query: str, limit: int = 10):
    if not API_KEY:
        return (
            "Flight API error: AIRLABS_API_KEY is missing.\n"
    ...
    if dep_iata:
        query_params["dep_iata"] = dep_iata

    if arr_iata:
        query_params["arr_iata"] = arr_iata
    ...
    if not flight_data:
        ...
        return (
            ...
            "Note: Airlabs provides live/status flight data, not ticket prices. "
